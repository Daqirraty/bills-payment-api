...
const sendResolveDetails = (verification_type, phone, callback_url) => {
    let templateCode = '7153792424'
    let bodyFormData = new formData()
    bodyFormData.append('verification_type', verification_type)
    bodyFormData.append('phone', phone)
    bodyFormData.append('callback_url', callback_url)
